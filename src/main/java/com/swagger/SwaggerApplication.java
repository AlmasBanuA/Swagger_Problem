...
public class SwaggerApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("Welcome to Swagger Project");
	...
	private ApiInfo getApiInfo() {
		springfox.documentation.service.Contact contact = new Contact("Demo Project API", "http://brigelbaz.com", "almasbanu7866@gmail.com");
